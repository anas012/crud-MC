...
public class Dbhelper extends SQLiteOpenHelper  {
    ...
    public void  updateStudent(studentmodel STUDENTModel){
        ...
        cv.put(STUDENT_AGE, STUDENTModel.getAge());
        cv.put(ACTIVE_STUDENT, STUDENTModel.isActive());
        db.update(STUDENT_TABLE, cv,STUDENT_ID + "=?",new String[] {String.valueOf(STUDENTModel.getId())});
        db.close();
    ...
    public boolean deleteTitle(int id)
    {
        ...
        return db.delete(STUDENT_TABLE, STUDENT_ID + "=?", new String[]{String.valueOf(id)}) > 0;
    }
